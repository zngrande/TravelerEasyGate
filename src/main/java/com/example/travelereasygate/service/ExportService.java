...
import com.example.travelereasygate.DAO.ExportHistoryDAO;
...
public class ExportService {
    ...
    private void insertItemImage(XWPFDocument doc, int PID, int AID, java.util.Set<Integer> excludedImageIds) {
        ...
        List<com.example.travelereasygate.entity.ImageAsset> images = imageAssetDAO.findByPoi(PID, AID);
        if (images.isEmpty()) return;

        for (com.example.travelereasygate.entity.ImageAsset image : images) {
