...
CREATE TABLE `ai_import` (
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `template_style` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT 'default'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- 資料表的匯出資料 `export_history`
--

INSERT INTO `export_history` (`EHID`, `ITID`, `format`, `file_url`, `generated_by`, `generated_at`) VALUES
(1, 3, 'docx-b2b', NULL, 1, '2026-08-07 13:34:23');
...
INSERT INTO `itinerary` (`ITID`, `AID`, `created_by`, `title`, `country`, `days_count`, `start_date`, `end_date`, `group_size`, `status`, `created_at`, `updated_at`, `template_style`) VALUES
(1, 1, 1, '北海道經典六日游', '日本北海道', 5, '2026-08-06', '2026-08-10', NULL, 'draft', '2026-08-06 09:29:02', '2026-08-06 09:29:02', 'default'),
(2, 1, 1, '北海道3日遊', '日本北海道', 3, '2026-09-07', '2026-09-09', NULL, 'draft', '2026-08-06 09:41:24', '2026-08-06 09:41:24', 'default'),
(3, 1, 1, '【冰雪秘境】日本東北藏王樹冰絕景、銀山溫泉5日大內宿、會津若松城、新幹線子彈列車', '日本東北', 5, '2026-08-06', '2026-08-10', NULL, 'draft', '2026-08-06 15:02:46', '2026-08-06 15:02:46', 'default'),
(4, 1, 1, '【四國秘境全覽】小豆島跳島溫泉美食五日', '日本四國', 5, '2026-08-06', '2026-08-10', NULL, 'draft', '2026-08-06 15:27:53', '2026-08-06 15:27:53', 'default');
...
(19, 9, NULL, 'attraction', '採草莓體驗', 3, NULL, NULL, NULL, NULL),
(20, 9, NULL, 'meal', '日式壽司餐盒+日本茶', 2, NULL, NULL, NULL, NULL),
...
(26, 10, NULL, 'attraction', '第一只見川橋梁展望台', 4, NULL, NULL, NULL, NULL),
(27, 10, NULL, 'meal', '手打蕎麥御膳或日式鍋物料理', 2, NULL, NULL, NULL, NULL),
(28, 10, NULL, 'attraction', '會津若松城', 3, NULL, NULL, NULL, NULL),
...
(36, 11, NULL, 'attraction', '銀山溫泉街', 5, NULL, NULL, NULL, NULL),
(37, 11, NULL, 'meal', '日式涮涮鍋食放題+軟式飲料暢飲', 4, NULL, NULL, NULL, NULL),
...
(41, 12, NULL, 'attraction', '五大堂', 4, NULL, NULL, NULL, NULL),
(42, 12, NULL, 'meal', '松島名物牛舌、牡蠣風味御膳', 2, NULL, NULL, NULL, NULL),
(43, 12, NULL, 'attraction', '鹽竈神社', 3, NULL, NULL, NULL, NULL),
...
--
ALTER TABLE `export_history`
  MODIFY `EHID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
